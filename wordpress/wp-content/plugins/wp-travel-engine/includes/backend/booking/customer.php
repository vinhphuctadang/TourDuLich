	...
	<div class="wpte-block">
			<div class="wpte-block-content">
				<ul class="wpte-list">
					...
					<li>
						<b><?php _e( 'First Name', 'wp-travel-engine' ); ?></b>
						<span>
					...
					<li>
						<b><?php _e( 'Last Name', 'wp-travel-engine' ); ?></b>
						<span>
					...
					<li>
						<b><?php _e( 'Address', 'wp-travel-engine' ); ?></b>
						<span>
					...
					<li>
						<b><?php _e( 'City', 'wp-travel-engine' ); ?></b>
						<span>
					...
					<li>
						<b><?php _e( 'Post Code', 'wp-travel-engine' ); ?></b>
						<span>
