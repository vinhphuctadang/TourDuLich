...
?>
            ...
            <div class="wpte-onoff-popup" <?php echo $enable_image_gallery ? 'style=display:block' : ''; ?>>
                <div class="wpte-gallery">
                    ...
                    <div id="wpte-gal-img-upldr-btn" class="wpte-img-uploader">
                        ...
                        <span class="wpte-tooltip"><?php printf( __( 'Max. file size %1$s Supports: JPG,PNG images', 'wp-travel-engine' ), '5MB' ); ?></span>
                    </div>
        ...
        <div class="wpte-onoff-block">
            ...
            <div class="wpte-onoff-popup" <?php echo $enable_video_gallery ? 'style=display:block' : ''; ?>>
                <div class="wpte-field wpte-url">
                    <input id="wte-trip-vid-url" type="text" placeholder="<?php _e( 'Enter youtube/vimeo video URL', 'wp-travel-engine' ); ?>">
                    <button class="wp-travel-engine-trip-video-gallery-add-video"><?php _e( 'Add Video', 'wp-travel-engine' ); ?></button>
                </div>
                            ...
                            ?>
                                <li class="wte-video-gal-<?php echo esc_html( $video_type ); ?>">
                                    ...
                                    ?>
                                        ...
                                        <small><a class="remove-video" href="#"><?php _e( 'Remove video', 'wp-travel-engine' ); ?></a></small>
                                    <?php 
                                        } else {
                                    ?>
        ...
        <div class="wpte-info-block">
            ...
            _e( sprintf('You can use this shortcode <b>%1$s</b> to display Video Gallery of this trip in posts/pages/tabs or use this snippet <b>%2$s</b> to display Video Gallery in templates.',$page_shortcode, $template_shortcode),'wp-travel-engine');?></p>
            <p>
    ...
    <?php if ( $next_tab ) : ?>
        <div class="wpte-field wpte-submit">
            <input data-tab="gallery" data-post-id="<?php echo esc_attr( $post_id ); ?>" data-nonce="<?php echo esc_attr( wp_create_nonce( 'wpte-trip-tab-save-continue' ) ); ?>" data-next-tab="<?php echo esc_attr( $next_tab['callback_function'] ); ?>" class="wpte_save_continue_link" type="submit" name="wpte_trip_tabs_save_continue" value="<?php _e( 'Save &amp; Continue', 'wp-travel-engine' ); ?>">
        </div>
    <?php endif;
