    ...
    <div class="wpte-form-block">
            ...
            <div class="wpte-form-content">
                <div class="wpte-field wpte-text wpte-floated">
                    ...
                    <input type="text" name="wp_travel_engine_setting[overview_section_title]" value="<?php echo esc_attr( $overview_section_title ); ?>" placeholder="Enter Here">
                ...
                <div class="wpte-field wpte-textarea wpte-floated wpte-rich-textarea delay">
                    ...
                    <textarea 
                        placeholder="<?php _e('Trip Overview:', 'wp-travel-engine'); ?>"
        ...
        <div class="wpte-form-block">
            ...
            <div class="wpte-form-content">
                <div class="wpte-field wpte-text wpte-floated">
                    <label class="wpte-field-label"><?php _e( 'Section Title', 'wp-travel-engine' ); ?></label>
                    <input type="text" name="wp_travel_engine_setting[trip_highlights_title]" value="<?php echo esc_attr( $trip_highlights_title ); ?>" placeholder="Enter Here">
                    <span class="wpte-tooltip"><?php _e( 'Enter title for the Trip Highlights section.', 'wp-travel-engine' ) ?></span>
                </div>
                ...
                <div class="wpte-repeater-wrap wpte-trip-highlights-hldr">
                    ...
                    <script type="text/html" id="tmpl-tour-highlight-row">
                        <div class="wpte-repeater-block wpte-sortable wpte-trp-highlight">
                            <div class="wpte-field wpte-field-gray wpte-floated">
                                <input required type="text" name="wp_travel_engine_setting[trip_highlights][{{data.key}}][highlight_text]" value="" placeholder="<?php esc_attr_e( 'Enter trip highlight', 'wp-travel-engine' ); ?>">
                                <button class="wpte-delete wte-delete-highlight"></button>
                            </div>
                        </div> <!-- .wpte-repeater-block -->
                    </script>
                ...
                <div class="wpte-add-btn-wrap">
                    <button class="wpte-add-btn wte-add-trip-highlight"><?php esc_html_e( 'Add trip highlight', 'wp-travel-engine' ); ?></button>
                </div>
            </div>
        </div> <!-- .wpte-form-block -->
